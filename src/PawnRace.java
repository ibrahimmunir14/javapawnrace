...
public class PawnRace {
  public static void main(String[] args) {
    ...
    while (!game.isFinished()) {
      ...
      Move thisMove = null;
      if (currentPlayer.isComputerPlayer()) { // Computer's turn
        ...
        do {
            System.out.println((currentPlayer.getColour() == Colour.WHITE ? "White" : "Black") + "'s turn. Please enter a move: ");
            inputSAN = scan.next().toLowerCase();
            thisMove = game.parseMove(inputSAN);
        } while (thisMove == null);
        game.applyMove(thisMove);
      }
      System.out.println((currentPlayer.getColour() == Colour.WHITE ? "White" : "Black") + " has played "
                         + thisMove.getFrom().getCol() + thisMove.getFrom().getRow() + " to " + thisMove.getTo().getCol() + thisMove.getTo().getRow());
      System.out.println("=================================");
      System.out.println();
    }
    System.out.println();
